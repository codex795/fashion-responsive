...
buttons.forEach(btn => {
    btn.addEventListener('click', () => {
        ...
        if (type === 'skill') {
            ...
            ${createSkillItem("photo/IMG_20250509_095013.jpg", "Dynamic anime boy illustrations designed with sharp lines, expressive poses and detailed shading. Har character me attitude, confidence aur stylish fashion sense dikhaya jata hai. Clean proportions aur smooth highlights use karke overall look ko bold, attractive aur visually appealing banaya jata hai.")}
            ${createSkillItem("photo/IMG_20250517_182100.jpg", "Elegant anime girl artwork featuring soft lines, balanced proportions and graceful expressions. Har design me delicate detailing, smooth shading aur stylish outfits ka perfect combination hota hai. Illustrations ko is tarah create kiya jata hai ki wo fashion concepts ko visually beautiful aur eye-catching banaye.")}
            ${createSkillItem("photo/chatgpt-1757149497129.jpg", "Realistic girl sketches created with natural proportions, clean outlines and expressive detailing. Har portrait me skin texture, facial features aur hair flow ko carefully highlight kiya jata hai. Yeh drawings fashion looks ko real-world feel deti hain aur overall presentation ko professional banati hain.")}
            ${createSkillItem("photo/IMG-20251106-WA0007.jpg", "Delicate pencil strokes se bani ye portrait simplicity aur depth ka perfect blend dikhati hai, jahan emotions, posture aur detailing milkar ek graceful artistic expression create karte hain.")}
            ${createSkillItem("photo/ChatGPT Image Nov 21, 2025, 01_55_10 PM.png", "Soft pastel tones aur elegant silhouette milkar ek calm, graceful style create karte hain jo har look ko subtle sophistication deta hai.")}</div>`;
        }
